...
const contactItems = [
  { icon: Mail, label: 'Email', value: 'setup.support@dost.gov.ph' },
    ...
    <AnimatedSection id="contact" className="bg-[#f3f8ff] px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
        <div className="rounded-2xl bg-[#07195f] p-7 text-white shadow-2xl shadow-blue-950/20 sm:p-10">
          <p className="text-sm font-black uppercase text-blue-100">Contact</p>
          <h2 className="mt-4 text-3xl font-black leading-tight sm:text-4xl">
            Start your MSME technology upgrading journey
          </h2>
          <p className="mt-4 max-w-xl text-sm leading-7 text-blue-100 sm:text-base">
            This section is prepared for beneficiary inquiries and can be wired to
            the Laravel API when public application endpoints are added.
          </p>
        ...
        <Card className="scroll-mt-32 shadow-xl shadow-blue-950/10" id="proposal">
          <CardContent className="p-6 sm:p-8">
            <p className="text-sm font-black uppercase text-[#0f53b7]">Beneficiary inquiry</p>
            <h3 className="mt-3 text-2xl font-black text-slate-950">Send your interest</h3>
            <div className="mt-6 grid gap-4">
              ...
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Enterprise category</span>
                <select className="mt-2 h-12 w-full rounded-lg border border-slate-300 px-3 text-sm outline-none transition focus:border-[#0f53b7] focus:ring-4 focus:ring-blue-100">
                  ...
                  <option>Product-Based Enterprise</option>
                  <option>Food and Retail Enterprise</option>
                </select>
              </label>
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Technology need</span>
                <textarea
                  ...
                  placeholder="Briefly describe your technology upgrading need"
                />
              </label>
