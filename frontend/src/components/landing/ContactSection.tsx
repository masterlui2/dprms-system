/**
 * System: DPRMS
 * Purpose: Render contact section for the frontend.
...
/** Render contact section and its available actions. */
            ...
            <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
                <div className="rounded-2xl bg-[#07195f] p-7 text-white shadow-2xl shadow-blue-950/20 sm:p-10">
                    ...
                    <p className="mt-4 max-w-xl text-sm leading-7 text-blue-100 sm:text-base">
                        Use this section for general guidance on program fit, required documents,
                        and the proper office for proposal assistance.
                    </p>

                    <div className="mt-10 space-y-4">
                        {CONTACT_ITEMS.map((objItem) =>
                        {
                            const Icon = objItem.icon;

                            return (
                                <div
                                    className="flex items-center gap-4 rounded-xl border border-white/15 bg-white/10 p-4"
                                    key={objItem.label}
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold">{objItem.value}</p>
                                    </div>
                                </div>
                            );
                        })}
                ...
                <Card className="scroll-mt-32 shadow-xl shadow-blue-950/10" id="proposal">
                    <CardContent className="p-6 sm:p-8">
                        <p className="text-sm font-black uppercase text-[#0f53b7]">
                            Program inquiry
                        </p>
