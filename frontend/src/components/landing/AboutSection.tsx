/**
 * System: DPRMS
 * Purpose: Render about section for the frontend.
...
/** Render about section and its available actions. */
            ...
            <div className="mx-auto max-w-6xl">
                ...
                >
                    ...
                    <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-600">
                        Pick one form below. SETUP is for enterprise technology upgrading, while GIA
                        is for research, community, training, and science-based development
                        projects.
                    </p>
                </motion.div>
