/**
 * System: DPRMS
 * Purpose: Render document checklist filter bar for the frontend.
...
interface DocumentChecklistFilterBarProps
{
    ...
    setSearchQuery: (strValue: string) => void;
    strViewMode: 'list' | 'grid';
    setViewMode: (strValue: 'list' | 'grid') => void;
    strStatusTab: 'ALL' | 'VERIFIED' | 'UNDER_REVIEW' | 'RETURNED' | 'PENDING' | 'UPLOADED';
    setStatusTab: (
        strValue: 'ALL' | 'VERIFIED' | 'UNDER_REVIEW' | 'RETURNED' | 'PENDING' | 'UPLOADED',
    ) => void;
    blnIsFilterDropdownOpen: boolean;
...
/** Render document checklist filter bar and its available actions. */
export function DocumentChecklistFilterBar({
    ...
    strStatusTab,
    setStatusTab,
    blnIsFilterDropdownOpen,
    setIsFilterDropdownOpen,
    objStats,
}: DocumentChecklistFilterBarProps)
{
    const blnHasActiveFilter = strStatusTab !== 'ALL' || blnIsFilterDropdownOpen;
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-3xl border border-[#B5BFCD]/70 bg-white p-3 sm:px-4 shadow-sm">
            <div className="relative flex-1 min-w-0 sm:max-w-md">
                ...
                <input
                    ...
                    onChange={(objEvent) => setSearchQuery(objEvent.target.value)}
            ...
            <div className="flex items-center gap-2.5 shrink-0">
                ...
                <div className="relative">
                    <button
                        type="button"
                        onClick={() => setIsFilterDropdownOpen((blnPrevious) => !blnPrevious)}
                        className={cn(
                    ...
                    >
                        ...
                        <span>
                            {strStatusTab === 'ALL'
                                ? 'Filter'
                                : strStatusTab === 'VERIFIED'
                                    ? 'Verified'
                                    : strStatusTab === 'UNDER_REVIEW'
                                        ? 'In Review'
                                        : strStatusTab === 'RETURNED'
                                            ? 'Revision'
                                            : 'Missing File'}
                        </span>
                    </button>
...
} /* end DocumentChecklistFilterBar */
