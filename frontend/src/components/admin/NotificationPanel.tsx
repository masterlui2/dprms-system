    ...
    <aside className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-[min(390px,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-[#d8e1ee] bg-white shadow-2xl">
      ...
      <div className="max-h-[420px] divide-y divide-slate-100 overflow-y-auto">
        {loading ? (
          ...
          return (
            <button
              className={`flex w-full items-start gap-3 px-4 py-4 text-left transition hover:bg-blue-50/50 ${notification.is_read ? 'bg-white' : 'bg-blue-50/40'}`}
              key={notification.id}
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="mt-2 flex flex-wrap items-center gap-1.5 text-[10px] font-bold">
