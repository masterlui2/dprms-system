/**
 * System: DPRMS
 * Purpose: Render login brand panel for the frontend.
...
/** Render login brand panel and its available actions. */
export function LoginBrandPanel()
{
    return (
        <section className="relative hidden min-h-screen overflow-hidden bg-[#073b82] p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
            ...
            <DostBrand className="relative z-10" blnInverted />
            ...
            <div className="relative z-10 max-w-lg">
                ...
                <p className="mt-5 max-w-lg text-base leading-7 text-blue-100">
                    Submit proposals, receive official updates, and manage DOST-assisted projects
                    through one secure government portal.
                </p>
