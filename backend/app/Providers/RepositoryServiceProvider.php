...
use App\Repositories\ProjectModule\AccomplismentRepository;
use App\Repositories\ProjectModule\ActionRepository;
use App\Repositories\ProjectModule\ExecutiveSummaryRepository;
use App\Repositories\ProjectModule\OutputRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ExecutiveSummaryRepositoryInterface::class, ExecutiveSummaryRepository::class);
        $this->app->bind(AccomplishmentRepositoryInterface::class, AccomplismentRepository::class);
